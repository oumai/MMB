...
@interface SQImagePlayerView ()<UIScrollViewDelegate>
...
@implementation SQImagePlayerView
...
- (id)initWithDelegate:(id<SQImagePlayerViewDelegate>)delegate {
    self = [super init];
    if (self) {
...
- (void)reloadData {
    ...
    self.pageControl.numberOfPages = self.count;
    self.pageControl.currentPage = 0;
    self.pageControl.hidden = _count <= 1;
...
- (void)setPageControlPosition:(SQPageControlPosition)pageControlPosition {
    NSString *vFormat = nil;
    NSString *hFormat = nil;
    
    switch (pageControlPosition) {
        case SQPageControlPosition_TopLeft: {
            vFormat = @"V:|-0-[pageControl]";
            hFormat = @"H:|-[pageControl]";
            break;
        }
            
        case SQPageControlPosition_TopCenter: {
            vFormat = @"V:|-0-[pageControl]";
            hFormat = @"H:|[pageControl]|";
            break;
        }
            
        case SQPageControlPosition_TopRight: {
            vFormat = @"V:|-0-[pageControl]";
            hFormat = @"H:[pageControl]-|";
            break;
        }
            
        case SQPageControlPosition_BottomLeft: {
            vFormat = @"V:[pageControl]-0-|";
            hFormat = @"H:|-[pageControl]";
            break;
        }
            
        case SQPageControlPosition_BottomCenter: {
            vFormat = @"V:[pageControl]-0-|";
            hFormat = @"H:|[pageControl]|";
            break;
        }
            
        case SQPageControlPosition_BottomRight: {
            vFormat = @"V:[pageControl]-0-|";
            hFormat = @"H:[pageControl]-|";
            break;
        }
