...
@interface MyOrderYueZiVC ()<ViewPagerDataSource,ViewPagerDelegate>
...
- (UIViewController *)viewPager:(ViewPagerController *)viewPager contentViewControllerForTabAtIndex:(NSUInteger)index {
    switch (index) {
        case 0:
        {
            NoPayYueZiCenterOrderVC *headerlineVC = [NoPayYueZiCenterOrderVC new];    //未付款
            headerlineVC.serviceTypeId = self.serviceTypeId;
            return headerlineVC;
        }
            break;
        case 1:
        {
            YueZICenterOrderVC *entertainmentVC = [YueZICenterOrderVC new]; //已付款
            entertainmentVC.serviceTypeId = self.serviceTypeId;
