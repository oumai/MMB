...
@interface  BloodPressureRecordModel  : NSObject
...
@interface BloodPressureRecordModel ()

@end

@implementation BloodPressureRecordModel
...
@interface BloodPressureRecordCustomCell : UITableViewCell
...
@interface BloodPressureRecordCustomCell ()
...
@implementation BloodPressureRecordCustomCell
...
#import "BloodPressureRecordVC.h"

@interface BloodPressureRecordVC ()<UITableViewDataSource,UITableViewDelegate,DateDelegate>
...
@implementation BloodPressureRecordVC
        ...
        if ([[ASURLConnection getMsg:responseObject] isEqualToNumber:@1]) {
            ...
            else
            {
                for (int i = 0; i <dataArr.count; i++) {
                    BloodPressureRecordModel *model = [[BloodPressureRecordModel alloc] initWithDictionary:dataArr[i]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BloodPressureRecordCustomCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (nil == cell) {
        cell = [[BloodPressureRecordCustomCell alloc] initWithStyle:(UITableViewCellStyleDefault) reuseIdentifier:identifier];
    }
...
- (void)requestData
{
    [ASURLConnection requestAFNJSon:@{@"user_id":[NSNumber numberWithInteger:[self.user getUserMessageFromLocation].userId],@"date":self.dayStr,@"type":@6} method:@"renhe.system.healthy1Data" view:self.view version:@"/v3" completeBlock:^(NSData *data, id responseObject) {
