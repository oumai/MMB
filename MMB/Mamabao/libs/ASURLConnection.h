...
#define testNormalUrl  @"http://112.74.13.124:8080"//模拟正式接口+
#define testUrl @"http://10.0.2.124:8081" //测试接口
#define testDataUrl  @"http://10.0.1.115:8081" //正式测试接口

#define baseModel @"%@/mobile/api%@/handler.do?method=%@&params=%@&sign=%@" //URL  天使医生

#define renHeMode @"%@/RenHeMobile/api%@/handler.do?method=%@&params=%@&sign=%@"  //浙江仁和
#define testRenHeUrl @"http://10.0.2.124:9006" //测试接口
#define yangzixinUrl @"http://10.0.2.151:8080"
#define xianwang @"http://angeldoctor.6655.la:51934"
